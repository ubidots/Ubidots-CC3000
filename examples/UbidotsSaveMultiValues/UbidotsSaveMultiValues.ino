...
#define VARIABLE_LABEL_1 "temperature" // Assign the Ubidots variable label
#define VARIABLE_LABEL_2 "humidity" // Assign the Ubidots variable label
#define VARIABLE_LABEL_3 "pressure" // Assign the Ubidots variable label
#define VARIABLE_LABEL_4 "current" // Assign the Ubidots variable label
#define VARIABLE_LABEL_5 "voltage" // Assign the Ubidots variable label
